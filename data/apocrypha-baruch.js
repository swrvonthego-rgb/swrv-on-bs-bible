// Book of Baruch — KJV Apocrypha tradition (1611) / Brenton — Public Domain
// Chapters 1-5: Baruch, scribe of Jeremiah. Chapter 6: The Epistle (Letter) of Jeremiah,
// bound with Baruch in the Geneva Bible (1560) and KJV Apocrypha arrangement.
window.BARUCH = {
  "1": {
  ...
  "6": {
    "1": "A copy of an epistle, which Jeremy sent unto them which were to be led captives into Babylon by the king of the Babylonians, to certify them, as it was commanded him of God. Because of the sins which ye have committed before God, ye shall be led away captives into Babylon by Nabuchodonosor king of the Babylonians.",
    ...
    "4": "Beware therefore that ye in no wise be like to strangers, neither be ye afraid of them, when ye see the multitude before them and behind them, worshipping them.",
    ...
    "58": "Therefore it is better to be a king that sheweth his power, or else a profitable vessel in an house, which the owner shall have use of, than such false gods; or to be a door in an house, to keep such things safe as be therein, than such false gods; or a pillar of wood in a palace, than such false gods.",
    ...
    "67": "The beasts are better than they: for they can get under a covert and help themselves.",
    ...
    "70": "And likewise their gods of wood, and laid over with silver and gold, are like to a white thorn in an orchard, that every bird sitteth upon; as also to a dead body, that is cast into the dark.",
