...
const CACHE_NAME = 'swrv-kingdom-bible-v20260825-defrestore1';
const CORE_ASSETS = [
  './',
  './index.html',
  './manifest.json',
  './css/styles.css?v=20260825safearea1',
  ...
  // Active JS bundle
  './js/app.js?v=20260825defrestore1',
  ...
  './js/audio-bible.js?v=20260823repeat1',
