...
const CACHE_NAME = 'swrv-kingdom-bible-v20260825-repeathairtrigger1';
const CORE_ASSETS = [
  './',
  './index.html',
  './manifest.json',
  './css/styles.css?v=20260825landingsafe1',
  ...
  './js/audio-bible.js?v=20260825repeathairtrigger1',
