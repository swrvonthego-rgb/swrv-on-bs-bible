...
const CORE_ASSETS = [
  ...
  './manifest.json',
  './css/styles.css',
  './js/app.js?v=20260521defaudit1',
  './js/search.js?v=20260521defaudit1',
  './js/preload-bible.js?v=20260521defaudit1',
  './data/english-bible-dictionary.js?v=20260521defaudit1',
  './data/foundational-word-families.js?v=20260521defaudit1',
  './data/concept-completeness-pack.js?v=20260521defaudit1',
  './data/contextual-sense-notes.js?v=20260521defaudit1',

  './data/context-sense-disambiguator.js?v=20260521defaudit1',
  './data/cultural-context-cards.js?v=20260521defaudit1',
  './data/instruction-classification.js?v=20260521defaudit1',
  './data/person-context-cards.js?v=20260521defaudit1',
  './data/group-nation-cards.js?v=20260521defaudit1',
  './data/religion-context-cards.js?v=20260521defaudit1',
  './assets/cover.png',
