...
function showModal(type){
  ...
  if(type==='prehistory'){
    ...
    body.innerHTML =
      ...
      '<p>This is a book about the covenant that we have with Elohim. It is not a history book. So if you\'re looking for history lessons, there\'s a lot of gaps and a lot of things that aren\'t recorded. You have to understand that as the Israelites were shifted and taken into slavery, their language was changed and their customs and culture underwent significant changes. This book was written by scribes and by people who were dedicated to Elohim, and it was written to the culture of the ancient Near East. So a lot of the context is understood by those people.</p>'+
      '<p>To understand this Bible, you have to understand it was about a people who had a relationship with a God called Elohim. It records the highs, the mids, and the lows of that relationship. And as of now, the one thing that\'s left — this is for judgment of everyone — is that He loves us all. Period.</p>'+
      '<p>In that time, there were sacrifices given. That word: highly restricted and demonstrated a severe seriousness to a situation. God sacrificed His Son because He loved the corrupted version of His original intention of His kingdom, which once it was corrupted became called the world system. This whole thing was about Him bringing back the functionality of His kingdom that operates in plain sight and at the same time as our earthly kingdoms and systems. It\'s a kingdom that you can opt in and never be rejected from, governed by a King whose only judgment towards us now is His love.</p>'+
      '<p>He\'s not here to punish us. We are in the New Testament, which means the New Covenant, which is full of grace — a King who wants to woo and pursue us and wants us to choose Him by choice, not by command. He\'s not looking to make us feel bad or condemn us. He\'s had people record and unravel these writings — and even me, at such a time as this — because He wants to connect through His Spirit to explain, set free, and make whole.</p>'+
      '<p>Knowledge is the key. With this Bible, you don\'t need interpreters. You don\'t have to be concerned if the pastor has good intentions. Because this just takes what was originally written and makes it available in English — without plans of grandeur, without colonization, without some hidden agenda. There\'s just the word and what it means and what it meant to the people it was written to.</p>'+
      '<p>I encourage you to still study deeply. I tried to encompass and put everything into this that I could think of, and I\'m open to suggestion. I really wanna hear from you about how we can take this and make it better.</p>'+
