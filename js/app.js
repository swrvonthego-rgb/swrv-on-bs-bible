...
const SWRV_DISCLAIMER_KEY = 'swrv_disclaimer_seen_v1';
function dismissSplash(){
  ...
  // "A Quick Word" — the covenant-not-history-book framing for this whole
  // project — shown once, the moment someone actually enters the reading
  // app (not on the marketing splash itself, which reappears every
  // session). Always reachable again afterward from More → A Quick Word.
  // Marked seen immediately rather than on close, so however someone
  // dismisses it (button, backdrop click, Escape), it never auto-shows twice.
  try {
    if(!localStorage.getItem(SWRV_DISCLAIMER_KEY)){
      localStorage.setItem(SWRV_DISCLAIMER_KEY, '1');
...
window.SWRV_TERM_SUPPLEMENTS = Object.assign({}, window.SWRV_TERM_SUPPLEMENTS || {}, {
  ...
  // The 17 words below are the remaining gap identified by a whole-Bible
  // coverage audit (122,928 definable-word instances checked; these were
  // the only ones with no curated card, no Strong's-tag-specific sense,
  // and no entry in the Historical Dictionary — Easton's/Smith's are
  // encyclopedic dictionaries of names/places/customs, not general-purpose
  // dictionaries, so they don't carry ordinary verbs like "run" or "wait").
  fight:{def:'To struggle or contend, physically or spiritually. Paul\'s "fight the good fight" pictures the Christian life as a contest requiring discipline and endurance, not passive belief.', hebrew:'לָחַם / lacham (H3898) — to fight, wage war', greek:'ἀγωνίζομαι / agonizomai (G75) — to contend, struggle, as in an athletic contest; also πολεμέω / polemeo (G4170) — to make war'},
  wait:{def:'In biblical use, "wait" (especially "wait on/for the LORD") means active, hopeful expectation and trust, not passive killing of time. Isaiah 40:31: "those who wait on the LORD shall renew their strength."', hebrew:'קָוָה / qavah (H6960) — to wait, hope, look eagerly for; a major OT word for confident expectation', greek:'προσδοκάω / prosdokao (G4328) — to expect, wait for'},
  remember:{def:'To remember, in Scripture, is more than mental recall — it means to act on covenant obligations. When God "remembers" His covenant, He acts to fulfill it; when people are told to "remember," they\'re told to return to covenant faithfulness.', hebrew:'זָכַר / zakar (H2142) — to remember, call to mind, act upon', greek:'μνημονεύω / mnemoneuo (G3421) — to remember, be mindful of'},
  run:{def:'Literal running, but also a common metaphor for the disciplined pursuit of the Christian life — a race requiring endurance and purpose, not aimless motion.', hebrew:'רוּץ / ruts (H7323) — to run', greek:'τρέχω / trecho (G5143) — to run, used of the believer\'s race in 1 Cor 9:24 and Heb 12:1'},
  heal:{def:'To heal or make whole — physically, and often by extension spiritually/nationally. "YHWH Rapha" ("the LORD who heals you," Exodus 15:26) is one of God\'s covenant names.', hebrew:'רָפָא / rapha (H7495) — to heal, cure, restore to health', greek:'ἰάομαι / iaomai (G2390) — to heal, cure; also θεραπεύω / therapeuo (G2323)'},
  begin:{def:'To begin, start, or initiate. The Hebrew root behind this word (chalal) is notably the same root behind "profane" — beginning and defiling share a root idea of "breaking open" something previously whole or set apart.', hebrew:'חָלַל / chalal (H2490) — to begin; also to profane (a striking dual sense from the same root)', greek:'ἄρχομαι / archomai (G756) — to begin, be first'},
  trust:{def:'To rely on, feel confident in, and lean one\'s full weight on someone. The OT\'s central word for reliance on God, often set against trusting in wealth, armies, or human power instead.', hebrew:'בָּטַח / batach (H982) — to trust, have confidence, feel safe', greek:'πείθω / peitho (G3982) — to be persuaded, to trust, to have confidence in'},
  fool:{def:'In Scripture, a fool is not primarily unintelligent — the fool is morally and spiritually senseless, someone who rejects God\'s reality regardless of how clever they are. "The fool has said in his heart, there is no God" (Psalm 14:1).', hebrew:'נָבָל / naval (H5036) — senseless, morally foolish; also כְּסִיל / kesil (H3684), common in Proverbs', greek:'ἄφρων / aphron (G878) — without reason, foolish; also μωρός / moros (G3474)'},
  overcome:{def:'To conquer, prevail, win out over opposition. A key word in Revelation, where "to him who overcomes" introduces each promise to the seven churches — victory through faithful endurance, not raw force.', greek:'νικάω / nikao (G3528) — to conquer, overcome, prevail'},
  inherit:{def:'To receive as a permanent possession by right, promise, or covenant — not by earning it, but because of one\'s relationship to the one giving it. Rooted in the OT promise of the land, and reused in the NT for the believer\'s share in God\'s kingdom.', hebrew:'יָרַשׁ / yarash (H3423) — to inherit, take possession of, dispossess', greek:'κληρονομέω / kleronomeo (G2816) — to inherit, receive as one\'s allotted portion'},
  enemy:{def:'One who is hostile, an adversary — a person, nation, or spiritual power actively opposed to someone. Scripture instructs God\'s people toward radical responses to enemies (blessing, prayer, love) rather than assuming hatred is the default posture.', hebrew:'אֹיֵב / oyev (H341) — enemy, foe, from a root meaning "to hate"', greek:'ἐχθρός / echthros (G2190) — enemy, hostile'},
  leper:{def:'Someone afflicted with tsara\'ath — a Hebrew term covering a range of skin conditions (not only what modern medicine calls leprosy/Hansen\'s disease). Levitical law required ritual separation and priestly examination, primarily about ritual purity and community boundaries, not simply contagion.', hebrew:'צָרוּעַ / tsarua, from צָרַע / tsara (H6879) — to be leprous, struck with a skin disease', greek:'λεπρός / lepros (G3015) — a leper, one with a skin disease'},
  almighty:{def:'A title for God emphasizing total, sovereign power over all things. "El Shaddai" appears throughout Genesis and Job; "Pantokrator" appears repeatedly in Revelation\'s worship scenes.', hebrew:'שַׁדַּי / Shaddai (H7706) — Almighty, as in "El Shaddai"', greek:'παντοκράτωρ / pantokrator (G3841) — the Almighty, ruler of all'},
  hostility:{def:'Active enmity or opposition between people or groups. In the NT, Christ is described as breaking down "the dividing wall of hostility" between Jew and Gentile (Ephesians 2:14) — hostility as a barrier His death dissolves.', greek:'ἔχθρα / echthra (G2189) — enmity, hostility, hatred'},
  hostile:{def:'Actively opposed, in a state of enmity. Paul describes the unredeemed mind as "hostile to God" (Romans 8:7) — not merely indifferent, but in active opposition to His authority.', greek:'ἔχθρα / echthra (G2189) — enmity, hostility (adjectival use)'},
  oppose:{def:'To actively resist or set oneself against someone or something. Used of both human conflict and, notably, of God\'s own stance toward the proud: "God opposes the proud, but gives grace to the humble" (James 4:6).', greek:'ἀντιτάσσομαι / antitassomai (G498) — to set oneself against, resist, oppose'},
  rival:{def:'A competitor or opponent, especially one competing for the same position, honor, or relationship. Used of the tension between co-wives (e.g. Hannah\'s rival Peninnah, 1 Samuel 1) and more broadly of jealous competition.', hebrew:'צָרָה / tsarah (H6869/H6870) — a female rival, adversary (distinct from the more common word for "trouble")'},
  loins:{def:'In Hebrew anthropology the loins/waist were the seat of physical strength and procreative power — the place a person "girded" (tucked their robe into a belt) to ready themselves for labor, travel, or battle, and, euphemistically, the source from which one\'s descendants were said to come. Its affliction (as in Psalm 38:7) signals total bodily collapse, not merely a hip ailment.', hebrew:'מָתְנַיִם / mothnayim (H4975) — waist, loins; the seat of strength, as in "gird up thy loins"; חֲלָצַיִם / chalatsayim (H2504) — loins, hips, also tied to strength and lineage ("fruit of thy loins")', greek:'ὀσφύς / osphys (G3751) — waist, loins; used both literally (a belt "about the loins," Matthew 3:4) and of ancestry (Hebrews 7:5, 10 — a descendant still "in the loins" of an ancestor, not yet born)', senses:['The literal waist/hip region, where a garment or belt is fastened','The seat of physical strength and readiness for action ("gird up thy loins")','A euphemism for procreative power and lineage — one\'s descendants ("fruit of thy loins," "come out of thy loins")','In Levitical sacrifice, the specific anatomical region near the kidneys where the fat was removed for the altar (Leviticus 3:4, 3:10, 3:15, 4:9, 7:4) — a plain ritual/anatomical detail carrying no symbolic weight'], ane:'Across the Ancient Near East the loins/waist were considered the seat of a man\'s strength and the source of his offspring — so "loins" language stands in for both combat power (Deuteronomy 33:11, "smash the loins of those who rise against him") and lineage (Hebrews 7:10, Levi still "in the loins" of Abraham — i.e. not yet born — when Abraham paid tithes to Melchizedek). Girding the loins was the universal ANE gesture of readiness for hard labor, travel, or battle (1 Kings 18:46; Luke 12:35; Ephesians 6:14).', warning:'Don\'t read every occurrence the same way — Leviticus\'s "fat near the loins" is a plain butchery detail, while Psalm 38:7\'s "loins filled with burning" describes the psalmist\'s whole body giving out at what was understood as his seat of strength.', plain:'The waist/hip area — in Scripture it often stands for physical strength, readiness for action, or a person\'s line of descendants, not just body anatomy.'}
});
...
function showDef(word, opts){
  ...
  if(originalsToShow.length){
    ...
    for(const o of originalsToShow){
      ...
      if(o.translit) html.push(' <i>('+escapeHtml(o.translit)+')</i>');
      if(o.strongs) html.push(' <span style="color:var(--gold);font-size:11px;">'+escapeHtml(o.strongs)+'</span>');
      if(o.note) html.push('<br><span style="font-size:13px;">'+escapeHtml(o.note)+'</span>');
      html.push('</div>');
    }
    html.push('</div>');
  }
  ...
  // Sources / confidence (deep)
  if(deep && deep.sources && deep.sources.length){
    html.push('<div class="def-section" style="opacity:0.85;"><div class="def-section-label">Where this comes from</div><div class="def-section-text" style="font-size:12px;font-style:italic;">'+deep.sources.map(escapeHtml).join(' · ')+'</div></div>');
  }
  if(deep && deep.confidence){
    html.push('<div class="def-section" style="opacity:0.8;font-size:11px;"><span class="def-section-label">Confidence:</span> '+escapeHtml(deep.confidence)+(deep.category?' · <span class="def-section-label">Category:</span> '+escapeHtml(deep.category):'')+'</div>');
  }
...
var _APOCRYPHA_META = {
  ...
  baruch: {
    global: 'BARUCH', icon: '📜', title: 'Baruch + Letter of Jeremiah',
    credit: 'KJV Apocrypha tradition (1611) · Public Domain',
    blurb: 'Confession, wisdom, and hope from Jeremiah\'s scribe in Babylon. Chapter 6 is the Letter of Jeremiah against idols, bound with Baruch in the Geneva Bible. 6 chapters.',
    color: 'var(--gold)'
  },
  azariah: {
...
function showModal(type){
  ...
  if(type==='prehistory'){
    ...
    title.textContent='A Quick Word Before You Start';
    body.innerHTML =
      '<p style="font-weight:700;color:var(--gold);font-size:15px;">Quick disclaimer.</p>'+
      '<p>This is a book about the covenant we have with Elohim. It is not a history book. If you\'re looking for a complete historical record, you will find real gaps — a lot went unrecorded. Israel was displaced, enslaved, and moved across centuries; their language, customs, and culture shifted along the way. This text was written by scribes and people devoted to Elohim, for an ancient Near Eastern audience — which means a lot of the context was simply understood by the people it was written to, in ways it isn\'t automatically understood by us today.</p>'+
      '<p>To read this Bible well, you have to understand what it actually is: the record of a relationship between a people and their God. It records the highs, the middles, and the lows of that relationship — honestly, without cleaning it up. And if there\'s one thing that hasn\'t changed by the end of it, it\'s this: He loves us all.</p>'+
      '<p>In that world, sacrifice meant something specific — a restricted, deliberately weighty act that marked a situation as severely serious. God sacrificed His own Son because He loved the broken, corrupted version of His original kingdom intention — a kingdom that, once corrupted, became what we now call "the world system." This whole story is about restoring that kingdom\'s original function: a kingdom that operates in plain sight, right alongside our earthly kingdoms and systems — one you can opt into and never be rejected from, governed by a King whose only judgment toward us now is love.</p>'+
      '<p>We are living in the New Testament — the New Covenant — full of grace. This is a King who wants to woo and pursue us, who wants to be chosen, not commanded. He isn\'t here to punish us, make us feel bad, or condemn us. He\'s had people record and unravel these writings — even me, at a time such as this — because He wants to connect through His Spirit: to explain, to set free, to make whole.</p>'+
      '<p>Knowledge is the key. With this Bible, you don\'t need an interpreter. You don\'t have to wonder whether the pastor has good intentions. This tool just takes what was originally written and makes it available — in English — without delusions of grandeur, without an agenda, without colonization. Just the word, what it means, and what it meant to the people it was written to.</p>'+
      '<p>I still encourage you to study deeply — this isn\'t a substitute for that. I tried to build this to cover everything I could think of, and I\'m genuinely open to how we can make it better. If you have thoughts on that, I want to hear them.</p>'+
      '<p style="margin-top:18px;padding-top:14px;border-top:1px solid var(--line);font-size:12px;color:var(--fg-dim);font-style:italic;">— SWRV</p>';
  }else if(type==='rules'){
...
(function(){
  ...
  // Show after a short delay so the app loads first — but not on top of the
  // splash page or the first-open "A Quick Word" disclaimer (showModal
  // ('about'), triggered from dismissSplash). Polls rather than a flat
  // timeout so it waits however long someone actually spends on either of
  // those before stacking a second full-screen overlay on them.
  function waitThenOnboard(){
    const splashUp = document.body.classList.contains('splash-active');
    const modalUp = document.getElementById('modal') && document.getElementById('modal').classList.contains('show');
    if(splashUp || modalUp){ setTimeout(waitThenOnboard, 400); return; }
    setTimeout(buildOnboarding, 800);
  }
  if(!alreadyOnboarded()){
    if(document.readyState === 'loading'){
      document.addEventListener('DOMContentLoaded', waitThenOnboard);
    } else {
      waitThenOnboard();
    }
  }
...
(function(){
  ...
  document.addEventListener('click', function(e){
    ...
    var dockBtn = document.getElementById('dockFontTab');
    if(pop && pop.classList.contains('open') && !pop.contains(e.target) && e.target !== btn && !(dockBtn && dockBtn.contains(e.target))){
